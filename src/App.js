  ...
  constructor(props) {
    ...
    this.state = {
      ...
      catProducts: [
        ...
        { pid: 6, Product: "CatHair Bow", price: 2.85, Qty: 0 },
        { pid: 7, Product: "CatJacket", price: 10.95, Qty: 0 },
      ...
      dogProducts: [
        ...
        { pid: 14, Product: "DogHair Bow", price: 1.85, Qty: 0 },
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <h3 style={{ color: "blue" }}>All you need and more! </h3>
        <h3 style={{ color: "blue" }}>World leaders in pet nutrition.</h3>
        ...
        {this.state.Basket.length > 0 && (
          <h3>
            ...
            <h6>
              ...
              {this.state.Basket.reduce(this.BasketTotal, 0.0)}
            </h6>
          </h3>
        )}
